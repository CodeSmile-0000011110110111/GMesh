...
namespace CodeSmile.GraphMesh
{
	public sealed partial class GMesh
	{
		private JobHandle ScheduleCreatePlane(GMeshPlane parameters)
		{
			...
			var vertsJob = new CreatePlaneVerticesJob
			{
			...
			var planeJob = new CreatePlaneQuadsJob { Data = _data, PlaneVertexCount = vertexCount };
			return planeJob.Schedule(vertJobHandle);
		}

		[BurstCompile] [StructLayout(LayoutKind.Sequential)]
		private struct CreatePlaneVerticesJob : IJobParallelFor
		{
